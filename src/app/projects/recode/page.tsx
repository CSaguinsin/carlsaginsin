import ReCode from '../../../../public/recodes.png' 
import Image from "next/image";
import ReCodeLogo from '../../../../public/goodLogo.png' 
import ReCodeDesign from '../../../../public/recodeDesign.png' 
export default function Page() {
    return (
        <>
    <div className="flex justify-center items-center pt-[6rem]">
        <Image src={ReCode} alt="recode" className="h-[25rem] w-[50rem]" />
    </div>

    <div className="flex items-center justify-center">
    <div className="flex flex-col justify-center items-center pt-[6rem] max-w-[500px]">
        <h1 className="text-[4rem] font-bold">ReCode</h1>
        <p className="text-center">
            ReCode is designed to save valuable time and effort, enabling developers to focus more on innovation and complex problem-solving. By providing a reliable repository for reusable code, ReCode aims to foster a more efficient and effective coding environment for developers everywhere.
        </p>
    </div>
</div>

<div className="flex items-center justify-center pt-[10rem] space-x-6">
      <div>
          <Image src={ReCodeLogo} alt="recode" className='h-[20rem] w-[20rem]' />
      </div>  

      <div className='flex flex-col'>
          <h1 className="text-[3rem] font-bold">Features🎯</h1>
          <p className='max-w-[500px]'>
             ReCode: A purpose-built platform for developers, ReCode serves as a centralized repository where code snippets are compiled, stored, and effortlessly reused. With streamlined account creation, easy snippet addition, advanced search capabilities, instant updates, and safe deletion, ReCode enhances individual developer productivity and creativity. It’s where efficiency meets innovation! 🚀📝
          </p>
      </div>
</div>
...
<div className="flex items-center justify-center pt-[10rem] space-x-6">
      <div className='flex flex-col'>
          <h1 className="text-[3rem] font-bold">UI Design Process✍🎨</h1>
          <p className='max-w-[500px]'>
          When Im designing a software first I visualize what would be the color palettes, fonts, typography and Im also using the 8 point grid system for sizing, spacing, and laying out components relative to one another. This means that any padding, margin, button height, etc. is always a multiple of 8 pixels.
          </p>
      </div>

      <div>
          <Image src={ReCodeDesign} alt="recode" className='h-[25rem] w-[40rem]' />
      </div>  
</div>

<div className="flex items-center justify-center pb-10">
    <div className="flex flex-col items-center justify-center pt-[10rem] space-x-6">
              <h1 className="text-[3rem] font-bold">Tech Stack💻</h1>

              <div className="flex flex-row space-x-[3rem] flex-wrap mt-8">
                    ...
                    <svg viewBox="0 0 128 128">
                              ...
                              <path
                                ...
                                d="M89.578 67.969c10.516-15.528 10.79-32.754.817-51.672 7.39 7.515 11.953 17.832 11.953 29.21a41.526 41.526 0 0 1-4.235 18.329c-1.543 2.223-2.715 4.965-5.847 4.965a4.624 4.624 0 0 1-2.688-.832Zm0 0"
                              />
                              <path
                                style={{ fillRule: "evenodd", fill: "#fff", fillOpacity: 1 }}
                                d="M60.07 55.848c13.953 0 19.828-8.035 19.828-19.446 0-11.414-8.878-21.918-19.828-21.918-10.953 0-19.832 10.504-19.832 21.918 0 11.41 5.875 19.446 19.832 19.446Zm0 0"
                              />
                              <path
                                style={{ fillRule: "evenodd", fill: "#030776", fillOpacity: 1 }}
                                d="M62.176 28.898c0 4.5-3.332 8.145-7.438 8.145-4.105 0-7.437-3.645-7.437-8.145s3.332-8.148 7.437-8.148c4.106 0 7.438 3.648 7.438 8.148Zm0 0"
                              />
                              <path
                                style={{ fillRule: "evenodd", fill: "#fff", fillOpacity: 1 }}
                                d="M57.215 27.02c0 2.074-1.664 3.757-3.715 3.757-2.055 0-3.719-1.683-3.719-3.757 0-2.079 1.664-3.762 3.719-3.762 2.05 0 3.715 1.683 3.715 3.762Zm0 0"
                              />
                            </svg>
              ...
              <p className='pt-10 max-w-[500px]'>
              I leverages the TALL stack—Tailwind CSS, Alpine.js, Laravel, and Livewire. Tailwind CSS ensures a unique UI, Alpine.js adds interactivity, Laravel provides stability, and Livewire enables real-time updates. This deliberate choice reflects your commitment to developer-centric design, fostering a community where innovation thrives without barriers. 🚀📝
              </p>
    </div>
</div>
        </>
